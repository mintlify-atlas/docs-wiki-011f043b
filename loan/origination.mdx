...
```java
// fineract-loan-origination/…/config/LoanOriginationModuleIsEnabledCondition.java
...
| `…/data` | `LoanOriginatorData`, `LoanApplicationOriginatorData`, `LoanOriginatorTemplateData`, `LoanOriginatorsResponse`, `LoanOriginatorMappingResponse` |
| `…/service` | `LoanOriginatorReadPlatformService`, write service implementations |
...
| `…/enricher` | `LoanAccountDataV1OriginatorEnricher`, `LoanDelinquencyRangeDataV1OriginatorEnricher`, `LoanChargeDataV1OriginatorEnricher`, `LoanTransactionDataV1OriginatorEnricher`, `LoanRepaymentDueDataV1OriginatorEnricher`, `LoanTransactionAdjustmentDataV1OriginatorEnricher` |
| `…/helper` | `LoanOriginatorDetailsResolver` |
| `…/mapper` | `LoanOriginatorAvroMapper` |
| `…/serialization` | Request deserializers and validators |
...
|---|---|---|
| `LoanDelinquencyRangeDataV1OriginatorEnricher` | `LoanDelinquencyRangeDataV1` | Adds originator to delinquency events |
